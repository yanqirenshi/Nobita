...
riot.tag2('page02-sec_root', '<section-header title="NOBIT@: 友達"></section-header> <section-container title="概要"> </section-container> <section-container title="Class: G*AN"> <section-container title="Slots"> </section-container> <section-container title="Operators"> <section-container title="Function: find-g*an"> </section-container> <section-container title="Function: tx-make-g*an"> </section-container> <section-container title="Generic function: flash-across-ones-mind"> </section-container> <section-container title="Generic function: print-object"> </section-container> <section-container title="Generic function: jojo:%to-json"> </section-container> </section-container> </section-container> <section-container title="Class: 4NEO"> <section-container title="Slots"> </section-container> <section-container title="Operators"> <section-container title="Function: find-4neo"> </section-container> <section-container title="Function: tx-make-4neo"> </section-container> <section-container title="Generic function: print-object"> </section-container> <section-container title="Generic function: jojo:%to-json"> </section-container> </section-container> </section-container> <section-container title="Class: NOBIT@"> <section-container title="Slots"> </section-container> <section-container title="Operators"> <section-container title="Function: find-nobit@"> </section-container> <section-container title="Function: tx-make-nobit@"> </section-container> <section-container title="Generic function: nobit@-p"> </section-container> <section-container title="Generic function: print-object"> </section-container> <section-container title="Generic function: jojo:%to-json"> </section-container> </section-container> </section-container> <section-container title="CLASS図"> <section-contents> <p> </p> </section-contents> </section-container> <section-container title="他のクラス"> <section-container title="Class: node"> </section-container> <section-container title="Class: edge"> </section-container> <section-container title="Class: friend"> </section-container> </section-container>', '', '', function(opts) {
});

riot.tag2('page03-sec_root', '<section-header title="NOBIT@: 友情"></section-header> <section-container title="概要"> <section-contents> <p>友情とは情報を伝達するための絆です。</p> <p>だれかの思い付き(アイデア)が友情を駆け巡り、何かを生みだすのです。</p> </section-contents> </section-container> <section-container title="データ"> <section-container title="idea"> <section-container title="Variables"> <section-container title="Variable: *idea-id-counter*"> </section-container> </section-container> <section-container title="Operators"> <section-container title="Function: make-idea"> </section-container> </section-container> </section-container> </section-container> <section-container title="Class: FRIENDSHIP"> <section-container title="Slots"> </section-container> <section-container title="Operators"> <section-container title="Function: find-frendship-at-to-classes"> </section-container> <section-container title="Function: find-frendship-at-from"> </section-container> <section-container title="Function: find-frendship-at-to"> </section-container> <section-container title="Function: find-frendship"> </section-container> <section-container title="Function: assert-frendship-1-1"> </section-container> <section-container title="Function: assert-frendship-1-n"> </section-container> <section-container title="Function: assert-frendship"> </section-container> <section-container title="Function: %tx-make-frendship"> </section-container> <section-container title="Generic function: tx-make-frendship"> </section-container> </section-container> </section-container>', '', '', function(opts) {
});

riot.tag2('page04-sec_root', '<section-header title="NOBIT@: G×an\'s 心臓"></section-header> <section-container title="概要"> <p>友情を流れるもの。それは情報です。</p> <p>友情を流すもの。それは心臓です。G×an の</p> <p>G×an は上級魔族なので八つの心臓を持っています。</p> <p>この心臓が友情をドライブします。</p> </section-container> <section-container title="Variable: *hearts*"> <section-container title="Operators"> <section-container title="Function: get-heart"> </section-container> <section-container title="Function: add-heart"> </section-container> <section-container title="Function: rm-heart"> </section-container> </section-container> </section-container> <section-container title="Operators"> <section-container title="Function: heart-core"> </section-container> <section-container title="Function: %heart-core"> </section-container> </section-container> <section-container title="Variable: *hook-heart-core-before*"> <section-container title="Function: heart-core-before"> </section-container> </section-container> <section-container title="Variable: *hook-heart-core-after*"> <section-container title="Function: heart-core-after"> </section-container> </section-container>', '', '', function(opts) {
});

riot.tag2('page01-sec_root', '<section-header title="NOBIT@: Home"></section-header> <section-container title="セクション" data="{sections()}"> <sections-list data="{opts.data}"> </sections-list> </section-container>', '', '', function(opts) {
     this.sections = () => {
