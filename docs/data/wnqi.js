class WNQI {
    ...
    workpackages () {
        return [
            ...
            { _id: 10000038, name: 'find-4neo',                     type: 'operator', description: 'packge:nobit@' },
            { _id: 10000039, name: 'find-frendship',                type: 'operator', description: 'packge:nobit@' },
            { _id: 10000040, name: 'find-g*an',                     type: 'operator', description: 'packge:nobit@' },
            { _id: 10000041, name: 'find-hearts',                   type: 'operator', description: 'packge:nobit@' },
            { _id: 10000042, name: 'find-nobit@',                   type: 'operator', description: 'packge:nobit@' },
            { _id: 10000043, name: 'flash-across-ones-mind',        type: 'operator', description: 'packge:nobit@' },
            { _id: 10000044, name: 'get-4neo',                      type: 'operator', description: 'packge:nobit@' },
            { _id: 10000045, name: 'get-friend',                    type: 'operator', description: 'packge:nobit@' },
            { _id: 10000046, name: 'get-g*an',                      type: 'operator', description: 'packge:nobit@' },
            { _id: 10000047, name: 'get-heart',                     type: 'operator', description: 'packge:nobit@' },
            { _id: 10000048, name: 'get-nobit@',                    type: 'operator', description: 'packge:nobit@' },
            { _id: 10000049, name: 'start',                         type: 'operator', description: 'packge:nobit@' },
            { _id: 10000050, name: 'tx-make-4neo',                  type: 'operator', description: 'packge:nobit@' },
            { _id: 10000051, name: 'tx-make-frendship',             type: 'operator', description: 'packge:nobit@' },
            { _id: 10000052, name: 'tx-make-g*an',                  type: 'operator', description: 'packge:nobit@' },
            { _id: 10000053, name: 'tx-make-nobit@',                type: 'operator', description: 'packge:nobit@' },
            { _id: 10000054, name: 'tx-save-location',              type: 'operator', description: 'packge:nobit@' },
            { _id: 10000055, name: 'action!',                       type: 'operator', description: 'packge:nobit@.action' },
            { _id: 10000056, name: 'action-plan-cl',                type: 'operator', description: 'packge:nobit@.action' },
            { _id: 10000057, name: 'action-plan-op',                type: 'operator', description: 'packge:nobit@.action' },
            { _id: 10000058, name: 'karma-pool',                    type: 'operator', description: 'packge:nobit@.hearts' },
            { _id: 10000059, name: 'make-heart',                    type: 'operator', description: 'packge:nobit@.hearts' },
            { _id: 10000060, name: 'pop-karma',                     type: 'operator', description: 'packge:nobit@.hearts' },
            { _id: 10000061, name: 'push-karma',                    type: 'operator', description: 'packge:nobit@.hearts' },
            { _id: 10000062, name: 'start-heart',                   type: 'operator', description: 'packge:nobit@.hearts' },
            { _id: 10000063, name: 'stop-heart',                    type: 'operator', description: 'packge:nobit@.hearts' },
            { _id: 10000064, name: 'copy-idea',                     type: 'operator', description: 'packge:nobit@.idea' },
            { _id: 10000065, name: 'make-idea',                     type: 'operator', description: 'packge:nobit@.idea' },
            { _id: 10000066, name: 'karma-pool',                    type: 'operator', description: 'packge:nobit@.karma' },
            { _id: 10000067, name: 'make-karma-pool',               type: 'operator', description: 'packge:nobit@.karma' },
            { _id: 10000068, name: 'pop-karma',                     type: 'operator', description: 'packge:nobit@.karma' },
            { _id: 10000069, name: 'push-karma',                    type: 'operator', description: 'packge:nobit@.karma' },
            { _id: 10000070, name: 'qsize',                         type: 'operator', description: 'packge:nobit@.karma' },
            { _id: 10000071, name: 'rm-karma-at-idea-id',           type: 'operator', description: 'packge:nobit@.karma' },
            { _id: 10000072, name: 'add-to-pocket',                 type: 'operator', description: 'packge:nobit@.pocket' },
            { _id: 10000073, name: 'find-from-pocket',              type: 'operator', description: 'packge:nobit@.pocket' },
            { _id: 10000074, name: 'get-from-pocket',               type: 'operator', description: 'packge:nobit@.pocket' },
            { _id: 10000075, name: 'rm-from-pocket',                type: 'operator', description: 'packge:nobit@.pocket' },
            { _id: 10000076, name: 'class-symbol',                  type: 'operator', description: 'packge:nobit@.utilities' },
        ];
    }
    edges () {
        return [
