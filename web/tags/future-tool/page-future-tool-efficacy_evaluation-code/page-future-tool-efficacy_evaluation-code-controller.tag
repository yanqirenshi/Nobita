<page-future-tool-efficacy_evaluation-code-controller>
    ...
    <style>
     ...
     page-future-tool-efficacy_evaluation-code-controller > *:last-child {
         border-bottom: none;
         flex-grow: 1;
     }
     page-future-tool-efficacy_evaluation-code-controller > *.active {
         border-right: none;
         font-weight: bold;
     }
    </style>
