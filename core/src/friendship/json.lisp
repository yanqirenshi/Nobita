...
(defmethod jojo:%to-json ((obj friendship))
  (jojo:with-object
    ...
    (jojo:write-key-value "from_id" (slot-value obj 'shinra:from-class))
    (jojo:write-key-value "from_id" (slot-value obj 'shinra:to-id))
    (jojo:write-key-value "from_id" (slot-value obj 'shinra:to-class))
